...
@property (strong, nonatomic) CAAnimationGroup *groupAni;//组动画
@property (assign, nonatomic) BOOL shouldRecoverToNormalStatusWhenViewWillAppear_;
@property (strong, nonatomic) UIImageView *circleImageView;//显示圆圈的imageview
